...
client();(function () {var $gwt_version = "2.8.2";var $wnd = window;var $doc = $wnd.document;var $moduleName, $moduleBase;var $stats = $wnd.__gwtStatsEvent ? function(a) {$wnd.__gwtStatsEvent(a)} : null;var $strongName = 'A8E3D0A281AD441F8BB4DDA28C956513';function B(){}
function ii(){}
function ei(){}
function oi(){}
function Si(){}
...
function Zw(a,b,c,d){var e,f,g,h,i;if(d==null||Ic(d)){lo(b,c,Ac(d))}else{f=d;if(0==AC(f)){g=f;if(!('uri' in g)){debugger;throw Xh(new SC("Implementation error: JsonObject is recieved as an attribute value for '"+c+"' but it has no "+'uri'+' key'))}i=g['uri'];if(a.q&&!i.match(/^(?:[a-zA-Z]+:)?\/\//)){e=a.l;e=(h='/'.length,SD(e.substr(e.length-h,h),'/')?e:e+'/');Xy(b).setAttribute(c,e+(''+i))}else{i==null?Xy(b).removeAttribute(c):Xy(b).setAttribute(c,i)}}else{lo(b,c,hi(d))}}}
